...
layout(set = 2, binding = 3, r32ui) uniform restrict uimage3D ParticleBinningVolume;
layout(set = 2, binding = 4, r8_snorm) uniform restrict image3D MarkerVolume;
layout(set = 2, binding = 5, r32f) uniform restrict image3D VelocityComponentVolume;
